...
//Added- refetch from Tanstack Query- Solution for refresh after upload from cloudinary
      ...
      <Card className="py-0 rounded shadow-sm">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex gap-3">
                {deleteType === "SD" ? (
                  <Button
                    type="button"
                    className="bg-[#970909] text-white hover:bg-[#970909]"
                  >
        ...
        <CardContent className="pb-5">
          {selectedMedia.length > 0 && (
            <div className="py-2 px-3 bg-[#7F7F7F]/30 text-[#979797] mb-2 rounded flex justify-between items-center">
              <Label>
                <Checkbox
                  checked={selectAll}
              ...
              <div className="flex gap-2">
                {deleteType === "SD" ? (
                  <Button
                    // variant="destructive"
                    className="bg-[#970909] text-white cursor-pointer hover:bg-[#970909]"
